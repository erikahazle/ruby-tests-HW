...
def remove_nils_and_false_from_array(array)
  array.compact
  array.select { |value| value if true }
end
...
def array_sort_by_last_letter_of_word(array)
  array.sort_by { |word| word[word.length - 1]}
end
...
def separate_array_into_even_and_odd_numbers(array)
  numbers = [[], []]
  numbers[0] = array.select { |number| number.even?}
  numbers[1] = array.select { |number| number.odd?}
  return numbers 
end
...
def number_of_elements_that_are_palindromes(array)
  count = 0
  array.each { |element| count += 1 if element == element.reverse }
  return count
end
...
def total_of_array(array)
  array.inject { |total, number| total + number}
end
...
def average_of_array(array)
  total = array.inject { |total, number| total + number}
  avarage = (total.to_f / array.length.to_f).round
  return avarage
end
...
def add_together_keys_and_values(hash)
  hash.to_a.flatten.inject { |total, number| total + number}
end
